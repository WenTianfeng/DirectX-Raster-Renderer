...
void UI_Camera::Render()
{
	...
	{
		ImGui::DragFloat("Field of View", &camera_FovY, 0.1f, 60.0f, 179.0f, "%.2f");
		ImGui::DragFloat("Aspect", &camera_Aspect, 0.03f, 1.0f, 2.0f, "%.2f");
		ImGui::DragFloat("Near Clip", &camera_NearClip, 0.02f, 0.01f, 0.5f, "%.2f");
		ImGui::DragFloat("Far Clip", &camera_FarClip, 1.0f, 1000.0f, 2000.0f, "%.2f");
	}
}
